...
export function withSilk(
  ...
  return {
    ...
    webpack(config, options) {
      ...
      if (!isServer && inject) {
        // Create virtual modules plugin instance
        const virtualModules = new VirtualModulesPlugin()
        config.plugins.push(virtualModules)

        // Add custom plugin to hook into webpack compilation
        config.plugins.push({
          apply(compiler: any) {
