...
export function withSilk(
  ...
  return {
    ...
    webpack(config, options) {
      ...
      if (!isServer && inject) {
        // Create virtual module that imports the generated CSS
        // This makes webpack automatically inject <link> tag into HTML
        const cssImportPath = path.join(dir, outputFile)

        const virtualModules = new VirtualModulesPlugin({
          'node_modules/__silk_auto_inject__.js': `
// Auto-generated by @sylphx/silk-nextjs
// This file automatically imports the CSS generated by Silk
// Webpack will handle CSS extraction and injection into HTML
import ${JSON.stringify(cssImportPath)};
`
        })
